  ...
  return (
          ...
          <div className="hero-content flex flex-col items-center justify-center relative">
            <div className="relative">
              <Image src="warning1.svg" alt="warning image of productiondetails page" width={600}  height={600} className="object-contain h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128" />
