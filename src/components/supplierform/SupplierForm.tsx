...
const supplierSchema = z.object({
  partNo: z.string().min(10, "Part No. should be exactly 10 characters").max(10, "Part No. should be exactly 10 characters"),
  supplierName: z.string().min(1, "Supplier name is required").max(40, "Supplier name should be at most 40 characters"),
  modelName: z.string().min(4, "Model name should be at least 4 characters").max(25, "Model name should be at most 25 characters"),
  partName: z.string().min(2, "Part name should be at least 2 characters").max(35, "Part name should be at most 35 characters"),
  SCD: z.any().optional(),
  APQP: z.any().optional(),
